  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <ImageBackground source={require('../assets/login-bg.jpeg')} style={{ flex: 6, justifyContent: 'flex-start', alignItems: 'center', resizeMode: 'contain', height: SCREEN_HEIGHT-200, width: SCREEN_WIDTH, marginBottom: 120, paddingTop: 0 }}>
          <Animatable.View animation="zoomIn" iterationCount={1} style={{ height: 140, width: 140, alignItems: 'center', justifyContent: 'center', backgroundColor: '#fff', padding: 15, borderRadius: 5, marginTop: 0 }}>
        ...
        <Animatable.View animation="slideInUp" iterationCount={1} style={{ paddingBottom: 40, backgroundColor: "#fff" }}>
          <Animated.View style={{ height: this.loginHeight, backgroundColor: 'white' }}>
            <Animated.View style={{ opacity: headerTextOpacity, alignItems: 'flex-start', paddingHorizontal: 25, marginTop: marginTop }}>
              <Text style={{ fontSize: 24, marginBottom: 15 }}>Get Moving with Almalak</Text>
            </Animated.View>
